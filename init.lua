...
--  See `:help 'clipboard'`
--  NOTE: Don't do that please, Making my clipboard history greater than 2000 lines. Nvm it is full, and i got to searc how to clear it. Thanks
...
-- Activate spelling
vim.opt.spell = true
-- Put a default spelling language (EN_US)
...
require('lazy').setup({
  ...
  { 'Bilal2453/luvit-meta', lazy = true },
  {
    ...
    config = function(_, opts)
      ...
      --This is needed for nvim-ufo to
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      -- Add highlighting in words super useful
